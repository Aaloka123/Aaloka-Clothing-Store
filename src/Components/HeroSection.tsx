  ...
  return (
    ...
    >
      <div className=" sm:px-8 lg:px-20 py-12">
        <div className="flex flex-col lg:flex-row gap-8 justify-between items-cer">
          <div className="flex flex-col items-center lg:items-start">
            ...
            />
            <button className="bg-primary text-white h-[54px] text-[18px] sm:text-[20px] px-6 sm:px-10 py-3 mt-6 lg:mt-12 transition-shadow duration-300 hover:bg-primary/80 hover:shadow-xl hover:underline">
              SHOP NOW
            </button>
          </div>
          ...
          <div className="relative w-full lg:w-[550px] h-auto lg:h-[700px] flex justify-center">
            ...
            <div className="absolute bottom-4 lg:bottom-8 left-0 w-full text-white px-4 lg:px-9 pb-4 text-center transition-transform duration-300 hover:scale-105 hover:-translate-y-1">
              <p className="font-blastula text-2xl sm:text-3xl lg:text-4xl">
